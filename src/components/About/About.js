            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-16 lg:gap-24"> 
               <div className="order-2 md:order-1">
                  <div className="text-base">
                     <p className="leading-7">Hello! I'm Mizanur Rahman, a passionate programmer and Web developer. I'm a junior full-stack web developer based on JavaScript, Node JS, React, and Express. My core skill is based on JavaScript, and I love to do most of the things using JavaScript. I learned Basic UI Design using HTML and CSS years ago, but in the meantime, I realized that it was nothing but a drop of water in the ocean. I had a huge appetite to conquer the Web but didn't have a proper guideline. Then I started pushing myself to make a big jump into the JavaScript universe. After blindly running through a dark tunnel of frustration for weeks, months, and even years, I realized that this is the natural attitude of the programming universe. I made my own path and ran by myself until I shifted into React and then I learned React for the Frontend and Express for the Backend by my idol of this journey, Jhanker Mahbub. Now I feel I'm skilled enough to play the role of a Junior Web Developer in any international or local organization. I am available for any kind of job opportunity that suits my interests.</p>
                  </div>
